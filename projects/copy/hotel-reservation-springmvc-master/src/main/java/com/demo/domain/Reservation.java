...
public class Reservation {
    ...
    public Integer getTotalCostIncludingTax() {
		...
		String convertedTotalCost = String.valueOf(
				Math.round(getTotalCostExcludingTax().add(getTaxableAmount()).doubleValue()));

        return Integer.parseInt(convertedTotalCost);
    }
