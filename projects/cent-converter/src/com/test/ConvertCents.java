...
public class ConvertCents {
	final static int cent = 100;             // number of cents in dollar
	   ...
	   public static void main (String[] args) {
	      ...
	      numDollars = dollar/cent;
	      System.out.println("Testing: " + dollar * 100);
	       centsLeft = cent % dollar;
	      ...
	      System.out.print("For your total cents of  " + cent);
